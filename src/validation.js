...
export function validateRequest(body) {
  ...
  if (!['openai', 'anthropic', 'gemini'].includes(body.provider)) return "Select a supported provider.";
  if (typeof body.apiKey !== "string" || body.apiKey.length < 8 || body.apiKey.length > 500) return "Enter a valid API key.";
